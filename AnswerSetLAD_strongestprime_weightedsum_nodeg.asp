...
% ------------------------------------------------ %
%                                                  %  
%       STRONGEST PRIME PATTERN GENERATION         % 
%                -Weighted sum-                    %
%           (without degree as parameter)          %     
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%then minimize number of literals for prime (weighted with very small nbr <= 1/(nbr of features+1))
#maximize {1,X :covered(W,X);-1/1000000000,S :pat(S,B)}.
