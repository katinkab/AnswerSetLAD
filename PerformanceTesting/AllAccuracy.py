...
def getALLaccuracy(filename):
	...
	Predict = "2018-2019/AnswerSetLAD/AnswerSetLAD_predict_highoccurence.asp"
	#for primecover.asp
	...
	PredictProcess = subprocess.Popen([clingo, testASP, parsedprimecover, Predict], stdout=subprocess.PIPE)
	while True:
...
if __name__ == '__main__':
	...
	mydirectory = "2018-2019/AnswerSetLAD/data/IrvineRepository/CRED/variance_mu5_fold2/core/"
	
	trainDisjointASP = "2018-2019/AnswerSetLAD/data/IrvineRepository/CRED/variance_mu5_fold2/train_split2.asp"
	Pat_forCover = "2018-2019/AnswerSetLAD/data/IrvineRepository/CRED/variance_mu5_fold2/allprimes_forcover2.asp"

	testASP = "2018-2019/AnswerSetLAD/data/IrvineRepository/CRED/variance_mu5_fold2/test_split2.asp"
