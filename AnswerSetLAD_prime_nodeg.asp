...
%%%GENERATE%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%one pattern of any degree
1{pat(S,B):i(sign,_,S,B)}.

deg(D):-D=#sum{1,S,B:pat(S,B)}.
...
del_covered(W,X,(S,B)):-deg(D),i(W,X,_,_),pat(S,B),not i(W,X,S,B),#sum{1,(T,C):pat(T,C),i(W,X,T,C),(T,C)!=(S,B)}=D-1.
